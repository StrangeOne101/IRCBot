...
public class CommandHelp implements IBotCommand {
	...
	{
		sender.sendToChannel("List of commands: author cookies dictionary config raw real recover reboot quit perm mute shutup sudo unmute channels games help say msg self .dex .bing .random .lagtest .pic .ping .5050");
		return true;
	}
