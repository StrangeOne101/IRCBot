...
public class Utils 
{
	...
	{
		return baseString.replaceAll("%(?i)nick", IRCBot.getNick()).replaceAll("%(?i)sender", chansender.senderName).replaceAll("%(?i)channel", chansender.channelName).replaceAll("%(?i)s", chansender.senderName).replaceAll("%(?i)n", IRCBot.getNick()).replaceAll("%n", IRCBot.getNick()).replaceAll("%(?i)c", chansender.channelName).replaceAll("%(?i)bot", IRCBot.getNick());
	}
